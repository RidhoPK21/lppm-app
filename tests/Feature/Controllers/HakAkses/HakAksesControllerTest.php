...
class HakAksesControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // FIX: Buat tabel m_hak_akses secara manual di database testing
        // Ini mengatasi error "no such table: m_hak_akses"
        ...
        // Mock Inertia::always agar tidak error saat dipanggil controller
    ...
    public function post_change_berhasil_memperbarui_hak_akses()
    {
        ...
        // Cek Database (tabel m_hak_akses)
    ...
    public function post_delete_berhasil_menghapus_hak_akses()
    {
        ...
        HakAksesModel::create(['id' => 'del-1', 'user_id' => 'user123', 'akses' => 'test']);
        ...
        $this->assertDatabaseMissing('m_hak_akses', ['user_id' => 'user123']);
    }
    ...
    public function post_delete_selected_berhasil_menghapus_hak_akses_terpilih()
    {
        ...
        HakAksesModel::create(['id' => '1', 'user_id' => 'user1', 'akses' => 'a']);
        HakAksesModel::create(['id' => '2', 'user_id' => 'user2', 'akses' => 'b']);
        HakAksesModel::create(['id' => '3', 'user_id' => 'user3', 'akses' => 'c']);

        $controller = new HakAksesController;
        $response = $controller->postDeleteSelected($request);

        $this->assertEquals(302, $response->getStatusCode());
        $this->assertDatabaseMissing('m_hak_akses', ['user_id' => 'user1']);
        $this->assertDatabaseMissing('m_hak_akses', ['user_id' => 'user2']);
        $this->assertDatabaseHas('m_hak_akses', ['user_id' => 'user3']);
    }
